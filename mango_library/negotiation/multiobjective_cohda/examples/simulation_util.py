...
from mango_library.negotiation.multiobjective_cohda.mocohda_starting import MoCohdaNegotiationInteractiveStarterRole
...
async def simulate_mo_cohda_NSGA2(*, num_agents: int, targets: List[Target], num_solution_points: int,
    ...
    for _ in range(num_simulations):
        ...
        agents[0].add_role(
            MoCohdaNegotiationInteractiveStarterRole(num_solution_points=num_solution_points, target_params=None,
