...
# In this implementation of the problem Zitzler 3, every agent controls one variable.
...
#  For the version in which every agent can control each variable,
#  have a look at: Zitzler_3_version_1.py.
SIM_NAME = "Zitzler_3"
