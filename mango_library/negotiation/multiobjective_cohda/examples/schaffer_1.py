...
from mango_library.negotiation.multiobjective_cohda.multiobjective_cohda import MultiObjectiveCOHDARole, COHDA, \
...
if __name__ == '__main__':
    asyncio.run(simulate_schaffer('Schaffer_1', 'Testfile.hdf5'))
