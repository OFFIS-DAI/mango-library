...
async def simulate_zitzler_3_NSGA2(name, db_file):
    await simulate_mo_cohda_NSGA2(
        ...
        possible_interval=possible_interval, population_size=POPULATION_SIZE, sim_name=name, db_file=db_file
    )


if __name__ == '__main__':
    asyncio.run(simulate_zitzler_3_NSGA2(SIM_NAME, FILE))
