...
from mango_library.negotiation.multiobjective_cohda.data_classes import WorkingMemory
...
class MoCohdaNegotiationStartMessage:
    ...
    @coalition_id.setter
    def coalition_id(self, coalition_id):
        self._coalition_id = coalition_id
    ...
    @send_weight.setter
    def send_weight(self, send_weight):
        self._send_weight = send_weight
