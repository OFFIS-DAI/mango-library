...
_WINZENTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ethics_score', full_name='WinzentMessage.ethics_score', index=9,
...
WinzentMessage = _reflection.GeneratedProtocolMessageType('WinzentMessage', (_message.Message,), {
