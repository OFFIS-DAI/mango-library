...
def create_cohda_object(schedule_provider, part_id, memory_target_params, is_local_acceptable= None, counter=0, perf_func=None):
    if is_local_acceptable is None:
        is_local_acceptable = lambda x: True
...
test_perceive_params = [
                             (SystemConfig({}), SolutionCandidate(agent_id=1, perf=None, schedules={}),
                              [CohdaMessage(working_memory=WorkingMemory(
                                  ...
                                  solution_candidate=SolutionCandidate(schedules={2: [0, 0, 2]}, agent_id=2, perf=-3)
                              ))],
                              SystemConfig({2: ScheduleSelection([0, 0, 2], 1), 1: ScheduleSelection([0, 1, 2], 1)}),
                             ...
                             (SystemConfig({}), SolutionCandidate(agent_id=1, perf=None, schedules={}),
                              ...
                              SolutionCandidate(schedules=
                                                {2: [0, 0, 2], 1: [0, 1, 2], 3: [1, 0, 2]}, agent_id=1, perf=-5)
                              ),
                             ...
                             (SystemConfig(schedule_choices={1: ScheduleSelection([2, 2, 2], 1)}),
                              ...
                              SolutionCandidate(schedules=
                                                {2: [0, 0, 2], 1: [2, 2, 2], 3: [1, 0, 2]}, agent_id=1, perf=-8)
                              ),
]
